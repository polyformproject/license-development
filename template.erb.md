...
<%= lets_you %> run and make changes to this software for yourself or your company for 30 calendar days in a row to find out whether this software suits a particular application.
<% end %>
